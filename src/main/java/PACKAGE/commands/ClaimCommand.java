...
public class ClaimCommand implements CommandExecutor, TabCompleter {
    ...
    public ClaimCommand(PlotService plotService) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length != 1) {
            player.sendMessage(ChatColor.YELLOW + "Usage: /claim <plot>");
            return true;
        }

        PlotService.ClaimResult result = plotService.claimPlot(player, args[0]);
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        return plotService.getClaimablePlots().stream()
