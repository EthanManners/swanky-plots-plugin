...
public class UnclaimCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        String plotInput = args.length == 1 ? args[0] : null;
        PlotService.ActionResult result = plotService.unclaimOwnPlot(player, plotInput);
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        return plotService.getOwnedPlotNames(player.getUniqueId()).stream()
